...
describe('formatBbox', () => {
  it('prints one decimal in millimetres', () => {
    expect(formatBbox({ x: 95.7, y: 34.6, z: 6.8 })).toBe('95.7 × 34.6 × 6.8 mm')
    expect(formatBbox({ x: 42, y: 42, z: 21 })).toBe('42.0 × 42.0 × 21.0 mm')
  })
})
