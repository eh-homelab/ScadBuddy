...
export function ParamWidget({ param, value, fonts, extruder, onChange }: ParamWidgetProps) {
  switch (param.type) {
    case 'slider':
    ...
    case 'font':
      return <FontWidget param={param} value={String(value)} fonts={fonts} onChange={onChange} />
    case 'string':
