...
class TestPlateLookup:
    ...
    def test_h2c_carries_the_wrapping_detection_strip(self) -> None:
        """``wrapping_exclude_area`` = 145x310 .. 251x326 in GM042 (#122)."""
        assert plate_for("H2C").wrapping_exclusions == (Rect(145.0, 310.0, 251.0, 326.0),)
